...
with $\forall n, \sum_{k=1}^K{q_{kn}} = 1$ by Jensen's Inequality.
...
hard assignment vs soft | spherical cluster shapes vs covariance matrix | fast vs slow and more iterations | K-means can be used as initialization for EM.
